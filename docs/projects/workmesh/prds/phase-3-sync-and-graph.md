...
- Establish a sync engine interface (adapters deferred to Phase 4).
...
- Sync engine abstraction (interface only; external sync deferred).
...
- Sync engine interface is defined; external sync adapters are deferred to Phase 4.
